...
EntityBaseEntityCall_AvatarBase::EntityBaseEntityCall_AvatarBase(int32 eid, const KBString& ename) : EntityCall(eid, ename)
{
...
EntityCellEntityCall_AvatarBase::EntityCellEntityCall_AvatarBase(int32 eid, const KBString& ename) : EntityCall(eid, ename)
{
