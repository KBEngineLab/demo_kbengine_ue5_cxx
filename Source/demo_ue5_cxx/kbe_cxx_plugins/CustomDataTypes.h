...
class DATATYPE_ENTITY_FORBID_COUNTER : DATATYPE_BASE
{
public:
...
class DATATYPE_ENTITYID_LIST : DATATYPE_BASE
{
public:
...
class DATATYPE_AVATAR_DATA : DATATYPE_BASE
{
public:
...
class DATATYPE_AVATAR_INFOS : DATATYPE_BASE
{
public:
...
class DATATYPE_AVATAR_INFOS_LIST : DATATYPE_BASE
{
public:
	class DATATYPE__AVATAR_INFOS_LIST_values_ArrayType_ChildArray : public DATATYPE_BASE
	{
	public:
		DATATYPE_AVATAR_INFOS itemType;

		void createFromStreamEx(MemoryStream& stream, KBArray<AVATAR_INFOS>& datas)
		{
		...
		void addToStreamEx(Bundle& stream, const KBArray<AVATAR_INFOS>& v)
		{
...
class DATATYPE_BAG : DATATYPE_BASE
{
public:
	class DATATYPE__BAG_values22_ArrayType_ChildArray : public DATATYPE_BASE
	{
	public:
		class DATATYPE___BAG_values22_ArrayType_ArrayType_ChildArray : public DATATYPE_BASE
		{
		public:
			void createFromStreamEx(MemoryStream& stream, KBArray<int64>& datas)
			{
				uint32 size = stream.readUint32();
				while(size > 0)
				{
			...
			void addToStreamEx(Bundle& stream, const KBArray<int64>& v)
			{
				stream.writeUint32((uint32)v.Num());
				for(int i=0; i<v.Num(); ++i)
				{
		...
		void createFromStreamEx(MemoryStream& stream, KBArray<KBArray<int64>>& datas)
		{
			uint32 size = stream.readUint32();
			while(size > 0)
			{
		...
		void addToStreamEx(Bundle& stream, const KBArray<KBArray<int64>>& v)
		{
			stream.writeUint32((uint32)v.Num());
			for(int i=0; i<v.Num(); ++i)
			{
...
class DATATYPE_EXAMPLES : DATATYPE_BASE
{
public:
...
class DATATYPE_AnonymousArray_32 : DATATYPE_BASE
{
public:
	void createFromStreamEx(MemoryStream& stream, KBArray<int32>& datas);
	void addToStreamEx(Bundle& stream, const KBArray<int32>& v);
};
