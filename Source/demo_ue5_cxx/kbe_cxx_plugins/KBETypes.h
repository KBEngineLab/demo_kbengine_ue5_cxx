...
typedef KBString STRING;

typedef KBString KBE_UNICODE;

typedef float FLOAT;

typedef double DOUBLE;

typedef KBArray<uint8> PYTHON;

typedef KBArray<uint8> PY_DICT;

typedef KBArray<uint8> PY_TUPLE;

typedef KBArray<uint8> PY_LIST;

typedef KBArray<uint8> ENTITYCALL;

typedef KBArray<uint8> BLOB;

typedef KBVector2f VECTOR2;

typedef KBVector3f VECTOR3;

typedef KBVector4f VECTOR4;
...
typedef KBVector3f POSITION3D;

typedef KBVector3f DIRECTION3D;
...
class ENTITY_FORBID_COUNTER : public KBArray<int8>
{
public:
...
class ENTITYID_LIST : public KBArray<int32>
{
public:
...
{
public:
	KBArray<KBArray<int64>> values22;
