...
class EntityBaseEntityCall_AvatarBase : public EntityCall
{
public:
	...
	EntityBaseEntityCall_AvatarBase(int32 eid, const KBString& ename);

	virtual ~EntityBaseEntityCall_AvatarBase();
};

class EntityCellEntityCall_AvatarBase : public EntityCall
{
public:
	...
	EntityCellEntityCall_AvatarBase(int32 eid, const KBString& ename);
