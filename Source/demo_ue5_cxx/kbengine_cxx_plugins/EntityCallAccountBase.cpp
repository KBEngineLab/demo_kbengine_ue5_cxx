...
EntityBaseEntityCall_AccountBase::EntityBaseEntityCall_AccountBase(int32 eid, const KBString& ename) : EntityCall(eid, ename)
{
...
void EntityBaseEntityCall_AccountBase::reqCreateAvatar(uint8 arg1, const KBString& arg2)
{
...
void EntityBaseEntityCall_AccountBase::reqRemoveAvatar(const KBString& arg1)
{
...
EntityCellEntityCall_AccountBase::EntityCellEntityCall_AccountBase(int32 eid, const KBString& ename) : EntityCall(eid, ename)
{
