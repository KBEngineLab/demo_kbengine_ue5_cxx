...
KBMap<MessageID, Message*> Messages::loginappMessages;
KBMap<MessageID, Message*> Messages::baseappMessages;
KBMap<MessageID, Message*> Messages::clientMessages;
KBMap<KBString, Message*> Messages::messages;
...
void Message_Client_setSpaceData::handleMessage(MemoryStream& msgstream)
{
	...
	KBString arg2 = msgstream.readString();
	KBString arg3 = msgstream.readString();
